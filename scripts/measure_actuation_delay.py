...
Prerequisites:
- ODrive nodes must be running (left and right)
- Motors should be in CLOSED_LOOP_CONTROL state
- Robot should be safely supported (wheels free to spin)

The script will:
1. Send step velocity commands to wheels
2. Record actual velocity from encoder feedback
3. Analyze response to extract delay parameters
4. Save results to CSV and display summary
"""
