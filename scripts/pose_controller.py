...
class PoseController(Node):
    def __init__(self):
        ...
        self.declare_parameter('Kp_angular', 8.88) # 1.0
        self.declare_parameter('Ki_angular', 5.2)
        ...
        self.declare_parameter('Ki_angular_yaw', 1.3) # Default same as straight line
