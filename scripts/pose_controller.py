...
class PoseController(Node):
    def __init__(self):
        ...
        self.declare_parameter('Ki_angular', 5.25)
        self.declare_parameter('Kd_angular', 0.116)
        # Angular PID for yaw alignment only
        self.declare_parameter('Kp_angular_yaw', 1.905) # Default same as straight line
        self.declare_parameter('Ki_angular_yaw', 1.35) # Default same as straight line
        self.declare_parameter('Kd_angular_yaw', 0.09) # Default same as straight line
