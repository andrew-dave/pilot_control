...
class PoseController(Node):
    def __init__(self):
        ...
        self.declare_parameter('Kp_angular_yaw', 1.0) # Default same as straight line #3.81
        self.declare_parameter('Ki_angular_yaw', 0.0175) # Default same as straight line #1.35
